<template lang="pug">
  #app.h-screen.flex.flex-col.bg-gray-100
    ...
    router-view.max-h-full

    footer.bg-indigo-900.text-white.w-full.py-4.text-center.flex-grow-0
      p.font-light Made with
        |
        span.text-red-500.mx-2.text-xl ♥
        |  by 
        a.font-hairline.text-white(href="https://github.com/jiep", target="_blank", class="hover:underline") jiep
</template>
...
export default {
  computed: {
    isSettingsRoute() {
      return ["settings"].indexOf(this.$route.name) > -1;
    }
  }
};
</script>
